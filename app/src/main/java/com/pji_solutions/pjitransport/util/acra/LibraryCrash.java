package com.pji_solutions.pjitransport.util.acra;
...
public class LibraryCrash {
    ...
    private static final String EXTRA_SHOW_ERROR_DETAILS = "id.co.ilcs.eos.util.LibraryCrash.EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = "id.co.ilcs.eos.util.LibraryCrash.EXTRA_STACK_TRACE";
    private static final String EXTRA_IMAGE_DRAWABLE_ID = "id.co.ilcs.eos.util.LibraryCrash.EXTRA_IMAGE_DRAWABLE_ID";

    //General constants
    private final static String TAG = "LibraryCrash";
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "id.co.ilcs.eos.util.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "id.co.ilcs.eos.util.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "id.co.ilcs.eos.util.";
    ...
    private static int defaultErrorActivityDrawableId = 0;
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(LibraryCrash.EXTRA_IMAGE_DRAWABLE_ID, 0);
    }
