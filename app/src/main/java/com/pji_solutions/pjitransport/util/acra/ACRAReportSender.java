...
public class ACRAReportSender implements ReportSender {
    ...
    public void send(CrashReportData crashReportData) throws ReportSenderException {
        ...
        try {
            ...
            String title;
            title = "CRASH REPORT ILCS Apps";
            gMailSender.sendMail(title, reportBody, emailUsername, "satrio.djati@yandex.com");
//			gMailSender.sendMail(title, reportBody, emailUsername, "\n" + "satrio.djati@yandex.com"/*,tunggul.jati@pji-solutions.com*/);
